const ToolWorkspace = {
  ...
  template: `
    <div class="w-full flex flex-col space-y-6">
      ...
      <!-- Showcase Screen -->
      <div 
        class="w-full h-80 sm:h-96 rounded-3xl glass-panel border border-[var(--border-color)] neon-shadow flex items-center justify-center overflow-hidden relative"
      ...
      <!-- Main Controls Panel -->
      <div class="w-full glass-panel p-6 sm:p-8 rounded-3xl border border-[var(--border-color)] neon-shadow space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <!-- Color, Effect, Animation & Orientation -->
          <div class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-3">
                <!-- Native Color Picker Trigger Button -->
                <div class="relative w-10 h-10 rounded-xl overflow-hidden border border-[var(--border-color)] shrink-0 shadow-inner">
                  <input 
                    type="color" 
                    v-model="customSettings.textColor"
                    class="absolute inset-[-6px] w-[200%] h-[200%] cursor-pointer border-none bg-none outline-none"
                  />
                </div>
                <!-- Presets List -->
                <div class="flex flex-wrap gap-1.5">
                  <button 
                    ...
                    class="w-6 h-6 rounded-md border border-[var(--border-color)] transition duration-200 hover:scale-110 active:scale-95"
